...
const vector<float> Cube::templateVertices {
	...
	-0.5f, -0.5f, -0.5f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f, // 10
	 0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 1.0f, 1.0f, 1.0f, // 11
	 0.5f, -0.5f, -0.5f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, // 12
	 0.5f, -0.5f,  0.5f, 1.0f, 1.0f, 1.0f, 0.0f, 1.0f, // 13
...
Cube::Cube() : Entity(templateVertices, templateElements, {"kitten.png", "grass-8.png"}) {
	std::cout << "Cube is using default translation" << endl;
	glm::vec3 translation {0.0f, 0.0f, 0.0f};
	transform = glm::translate(transform, translation);
}

Cube::Cube(glm::vec3 translation) : Entity(templateVertices, templateElements, {"kitten.png", "grass-8.png"}) {
